...
ggplot(reads,
	aes(Sample)) +
    geom_line(aes(y=Raw_Read_Counts, color="Raw_Read_Counts")) +
    geom_line(aes(y=Trimmed_Read_Counts, color="Trimmed_Read_Counts")) +
    geom_line(aes(y=Mapped_Read_Counts, color="Mapped_Read_Counts")) +
